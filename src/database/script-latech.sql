...
(NULL, 'DHT11', 'Temp/Hum', 'Ativo', 1),
(NULL, 'DHT11', 'Temp/Hum', 'Ativo', 1),
(NULL, 'DHT11', 'Temp/Hum', 'Ativo', 1),
(NULL, 'DHT11', 'Temp/Hum', 'Ativo', 2),
(NULL, 'DHT11', 'Temp/Hum', 'Ativo', 3),
(NULL, 'DHT11', 'Temp/Hum', 'Ativo', 3),
(NULL, 'DHT11', 'Temp/Hum', 'Ativo', 4),
(NULL, 'DHT11', 'Temp/Hum', 'Ativo', 4),
(NULL, 'DHT11', 'Temp/Hum', 'Ativo', 4),
(NULL, 'DHT11', 'Temp/Hum', 'Ativo', 5),
(NULL, 'DHT11', 'Temp/Hum', 'Inativo', NULL),
(NULL, 'DHT11', 'Temp/Hum', 'Inativo', NULL),
(NULL, 'DHT11', 'Temp/Hum', 'Inativo', NULL),
(NULL, 'DHT11', 'Temp/Hum', 'Inativo', NULL);
